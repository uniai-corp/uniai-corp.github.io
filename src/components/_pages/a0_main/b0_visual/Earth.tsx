...
export default function PageMainVisualEarth({ trigger }: { trigger: HTMLElement | null }) {
  ...
  return (
    ...
    >
      <picture>
        <source media="(min-width: 1340px)" srcSet="/img/main/visual/earth_desktop_large.png" />
        <source media="(min-width: 1280px)" srcSet="/img/main/visual/earth_desktop_medium.png" />
        <source media="(min-width: 768px)" srcSet="/img/main/visual/earth_tablet.png" />
        <img
          src="/img/main/visual/earth_mobile.png"
          alt="global"
