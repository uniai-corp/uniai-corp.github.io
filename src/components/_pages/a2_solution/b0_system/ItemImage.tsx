    ...
    <figure>
      <picture>
        <source
          ...
          srcSet={`/img/solution/system/0${index}_desktop_large.png`}
        />
        <source
          media="(min-width: 1280px)"
          srcSet={`/img/solution/system/0${index}_desktop_medium.png`}
        />
        <source media="(min-width: 768px)" srcSet={`/img/solution/system/0${index}_tablet.png`} />
        <img
          src={`/img/solution/system/0${index}_mobile.png`}
          alt={alt}
